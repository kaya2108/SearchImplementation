...
int main(int argc, char const* const* argv) {
    ...
    // iterate through results to ensure the work is actually done
    size_t hit_count = 0;
    ...
    seqan3::debug_stream << "Search completed.\n";
    seqan3::debug_stream << "Total Hits: " << hit_count << "\n";
    seqan3::debug_stream << "Search Time: " << elapsed.count() << "s\n";
